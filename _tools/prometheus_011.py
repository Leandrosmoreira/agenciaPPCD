...
Uso:
  ...
  python _tools/prometheus_011.py
"""
...
VIDEO_DIR  = BASE_DIR / "canais/sinais-do-fim/videos/video-011-nefilim"
...
def main():
    print("=" * 60)
    print("PROMETHEUS — video-011-nefilim")
    ...
    tmp_dir = Path(tempfile.mkdtemp(prefix="prometheus_011_"))
    try:
