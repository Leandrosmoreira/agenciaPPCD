#!/usr/bin/env python3
"""
PROMETHEUS — video-013-segundo-selo
...
VIDEO_DIR  = BASE_DIR / "canais/sinais-do-fim/videos/video-013-segundo-selo"
...
def main():
    ...
    print("=" * 60)
    print("PROMETHEUS — video-013-segundo-selo")
    ...
    tmp_dir = Path(tempfile.mkdtemp(prefix="prometheus_013_"))
    try:
