...
video-010-biblia-etiope | Sinais do Fim
"""
...
VIDEO_FILE    = r'C:\Users\Leandro\Downloads\agencia\canais\sinais-do-fim\videos\video-010-biblia-etiope\7-edicao\0414 (3).mp4'
THUMB_FILE    = r'C:\Users\Leandro\Downloads\agencia\canais\sinais-do-fim\videos\video-010-biblia-etiope\8-publicacao\thumbs.png'
METADATA_FILE = r'C:\Users\Leandro\Downloads\agencia\canais\sinais-do-fim\videos\video-010-biblia-etiope\8-publicacao\metadata.txt'
STATUS_FILE   = r'C:\Users\Leandro\Downloads\agencia\canais\sinais-do-fim\videos\video-010-biblia-etiope\8-publicacao\status_upload.txt'
...
def upload_video(youtube, metadata):
    print('[CARONTE] Iniciando upload (4 GB — pode demorar)...')
    body = {
        'snippet': {
...
"""
    ...
    with open(LOG_FILE, 'a', encoding='utf-8') as lf:
        lf.write(f'[{now}] CARONTE -- video-010 Upload OK (PRIVATE) -> {video_id}\n')
...
def main():
    print('='*60)
    print('CARONTE — video-010-biblia-etiope | Sinais do Fim')
    print('='*60)
