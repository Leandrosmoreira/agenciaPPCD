#!/usr/bin/env python3
"""
PROMETHEUS — video-009-anticristo
...
Uso:
  ...
  python _tools/prometheus_009.py
"""
...
VIDEO_DIR  = BASE_DIR / "canais/sinais-do-fim/videos/video-009-anticristo"
...
def main():
    print("=" * 60)
    print("PROMETHEUS — video-009-anticristo")
    ...
    tmp_dir = Path(tempfile.mkdtemp(prefix="prometheus_009_"))
    try:
